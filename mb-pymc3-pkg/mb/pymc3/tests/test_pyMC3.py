...
from . import create_PyMC3_testmodels as pymc3testmodels


def create_testmodels(fit):
    models = []
    # These functions return the model data and the corresponding model
    models.append(pymc3testmodels.create_pymc3_simplest_model(fit=fit))
    models.append(pymc3testmodels.create_pymc3_getting_started_model(fit=fit))
    models.append(pymc3testmodels.create_pymc3_getting_started_model_independent_vars(fit=fit))
    models.append(pymc3testmodels.create_pymc3_coal_mining_disaster_model(fit=fit))
    models.append(pymc3testmodels.create_getting_started_model_shape(fit=fit))
    models.append(pymc3testmodels.create_flight_delay_model_1(fit=fit))
    models.append(pymc3testmodels.create_allbus_model_4(fit=fit))
    return models
