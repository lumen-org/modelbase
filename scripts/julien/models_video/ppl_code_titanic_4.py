...
def create_fun():
    def code_to_fit(file='../data/titanic_cleaned.csv', modelname='titanic_4', fit=True, dtm=None, pp_graph=None):
        ...
        with model:
            ...
            fare = pm.Normal('fare', mu=tt.switch(tt.eq(sex, 0), tt.switch(tt.eq(pclass, 0), age * -0.1021 + 66.0231875,
                                                                           tt.switch(tt.eq(pclass, 1),
                                                                                     age * -0.1614 + 66.0231875,
                                                                                     age * -0.0615 + 66.0231875)),
                                                  tt.switch(tt.eq(pclass, 0), age * -1.1111 + 66.0231875,
                                                            tt.switch(tt.eq(pclass, 1), age * -0.3316 + 66.0231875,
                                                                      age * 0.0988 + 66.0231875))),
                             sigma=tt.switch(tt.eq(sex, 0), tt.switch(tt.eq(pclass, 0), 48.3724625,
                                                                      tt.switch(tt.eq(pclass, 1), 48.3724625,
                                                                                48.3724625)),
                                             tt.switch(tt.eq(pclass, 0), 48.3724625,
                                                       tt.switch(tt.eq(pclass, 1), 48.3724625, 48.3724625))))
