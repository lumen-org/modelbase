...
# 32 parameter
#####################
def create_bnlearn_iris_tabubiccg(filename="", modelname="bnlearn_iris_tabubiccg", fit=True):
    if fit:
        modelname = modelname
    model = pm.Model()
    with model:
...
# 39 parameter
#####################
def create_bnlearn_iris_tabuaiccg(filename="", modelname="bnlearn_iris_tabuaiccg", fit=True):
    if fit:
        modelname = modelname
    model = pm.Model()
    with model:
...
# 36 parameter
#####################
def create_bnlearn_iris_interiamb(filename="", modelname="bnlearn_iris_interiamb", fit=True):
    if fit:
        modelname = modelname
    model = pm.Model()
    with model:
        ...
        petalwidth = pm.Normal('petalwidth', mu=tt.switch(tt.eq(species, 0), sepalwidth*0.0499+petallength*0.1819+-0.191, tt.switch(tt.eq(species, 1), sepalwidth*0.205+petallength*0.2543+-0.3252, sepalwidth*0.4146+petallength*0.0631+0.4424)), sigma=tt.switch(tt.eq(species, 0), 0.0997, tt.switch(tt.eq(species, 1), 0.1122, 0.2342)))
        sepallength = pm.Normal('sepallength', mu=tt.switch(tt.eq(species, 0), petallength*0.5423+4.2132, tt.switch(tt.eq(species, 1), petallength*0.8283+2.4075, petallength*0.9957+1.0597)), sigma=tt.switch(tt.eq(species, 0), 0.3432, tt.switch(tt.eq(species, 1), 0.3425, 0.3232)))
...
# 36 parameter
#####################
def create_bnlearn_iris_fastiamb(filename="", modelname="bnlearn_iris_fastiamb", fit=True):
    if fit:
        modelname = modelname
    model = pm.Model()
    with model:
...
# 32 parameter
#####################
def create_bnlearn_iris_hcbiccg(filename="", modelname="bnlearn_iris_hcbiccg", fit=True):
    if fit:
        modelname = modelname
    model = pm.Model()
    with model:
...
# 39 parameter
#####################
def create_bnlearn_iris_hcaiccg(filename="", modelname="bnlearn_iris_hcaiccg", fit=True):
    if fit:
        modelname = modelname
    model = pm.Model()
    with model:
...
# 36 parameter
#####################
def create_bnlearn_iris_gs(filename="", modelname="bnlearn_iris_gs", fit=True):
    if fit:
        modelname = modelname
    model = pm.Model()
    with model:
...
# 36 parameter
#####################
def create_bnlearn_iris_iamb(filename="", modelname="bnlearn_iris_iamb", fit=True):
    if fit:
        modelname = modelname
    model = pm.Model()
    with model:
        ...
        sepallength = pm.Normal('sepallength', mu=tt.switch(tt.eq(species, 0), 5.006, tt.switch(tt.eq(species, 1), 5.936, 6.588)), sigma=tt.switch(tt.eq(species, 0), 0.3525, tt.switch(tt.eq(species, 1), 0.5162, 0.6359)))
        sepalwidth = pm.Normal('sepalwidth', mu=tt.switch(tt.eq(species, 0), 3.428, tt.switch(tt.eq(species, 1), 2.77, 2.974)), sigma=tt.switch(tt.eq(species, 0), 0.3791, tt.switch(tt.eq(species, 1), 0.3138, 0.3225)))
        petallength = pm.Normal('petallength', mu=tt.switch(tt.eq(species, 0), sepallength*0.1316+0.8031, tt.switch(tt.eq(species, 1), sepallength*0.6865+0.1851, sepallength*0.7501+0.6105)), sigma=tt.switch(tt.eq(species, 0), 0.1691, tt.switch(tt.eq(species, 1), 0.3118, 0.2805)))
        petalwidth = pm.Normal('petalwidth', mu=tt.switch(tt.eq(species, 0), sepalwidth*0.0499+petallength*0.1819+-0.191, tt.switch(tt.eq(species, 1), sepalwidth*0.205+petallength*0.2543+-0.3252, sepalwidth*0.4146+petallength*0.0631+0.4424)), sigma=tt.switch(tt.eq(species, 0), 0.0997, tt.switch(tt.eq(species, 1), 0.1122, 0.2342)))
