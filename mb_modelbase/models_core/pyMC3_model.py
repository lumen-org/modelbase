    ...
    def _fit(self):
        with self.model_structure:
            ...
            for varname in self.model_structure.observed_RVs:
                # sample_ppc works the following way: For each parameter set generated by sample(), a sequence of points
                # is generated with the same length as the observed data. So, in the i-th row of the samples df, we want
                # to write the new data point that was generated by the i-th parameter set and the i-th row of the given
                # data: ppc[...][i][i].
