...
In addition to any dependencies required by the mb_modelbase package you also need:
    (1) more python packages installed. To install run from a command line shell:
...
from mb_modelbase.core import Model

from mb_modelbase.utils.data_import_utils import get_columns_by_dtype, to_category_cols


from mb_modelbase.core.mspn.tfspn.piecewise import estimate_domains
from mb_modelbase.core.mspn.tfspn.SPN import SPN, Splitting
