...
from mb_modelbase.core.base import *
from mb_modelbase.core.mixable_cond_gaussian import MixableCondGaussianModel as CondGaussian
from mb_modelbase.core.tests import test_crabs as crabs
