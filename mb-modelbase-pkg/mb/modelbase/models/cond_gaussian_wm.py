# Copyright (c) 2017-2020 Philipp Lucas and Frank Nussbaum, FSU Jena
import functools
import logging
import numpy as np
from numpy import pi, exp, dot, abs, ix_
from numpy.linalg import inv, det
import xarray as xr

from mb.modelbase.utils import utilities, no_nan
from mb.modelbase.core import models as md
from mb.modelbase.models import cond_gaussian_fitting as cgf, cond_gaussians as cg
...
def fit_CLZ(df, categoricals, numericals):
    ...
    return utilities.numpy_to_xarray_params(p, mu, Sigma, [meta['catuniques'][cat] for cat in categoricals], categoricals, numericals)
