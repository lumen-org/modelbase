...
class KDEModel(models.Model):
    ...
    def _marginalizeout(self, keep, remove):
        ...
        self._fit()
        _, cat_names, num_names = data_import.get_columns_by_dtype(self.data)
    ...
    def _density(self, x):
        ...
        x_df = pd.DataFrame([x])
        _, cat_names, num_names = data_import.get_columns_by_dtype(x_df)
...
if __name__ == "__main__":
    ...
    models.Model.save(kde_model, '/home/guet_jn/Desktop/mb_data/data_models')
